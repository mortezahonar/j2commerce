...
?>
<div class="j2commerce j2commerce-product-list uikit" data-link="<?php echo $activeLink; ?>" data-filter-catid="<?php echo !empty($this->filter_catid) ? (int) $this->filter_catid : ''; ?>" data-ajax-filters="<?php echo $enableAjaxFilters ? 'true' : 'false'; ?>">
