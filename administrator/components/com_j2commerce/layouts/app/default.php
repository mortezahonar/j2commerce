                ...
                <div class="card-body">
                    <div class="d-flex flex-column text-center h-100 pt-3">
                        <div class="mt-auto">
                            ...
                            <p class="text-body-secondary mb-5"><?php echo Text::_('COM_J2COMMERCE_APP_LAYOUT_CARDS_HELP_DESC');?></p>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex flex-column text-center h-100 pt-3">
                        <div class="mt-auto">
                            ...
                            <p class="text-body-secondary mb-5"><?php echo Text::_('COM_J2COMMERCE_APP_LAYOUT_CARDS_ADD_DESC');?></p>
                        </div>
                        <div class="text-center mt-auto mb-4">
